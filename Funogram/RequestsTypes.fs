...
let sendMessageReqBase = { ChatId = ChatId.Int 0L; Text = ""; ParseMode = None; 
    DisableWebPagePreview = None; DisableNotification = None; ReplyToMessageId = None;
    ReplyMarkup = None }
...
type SendInvoiceArgs = 
    { PhotoUrl: string option
      ...
      ReplyToMessageId: int option
      ReplyMarkup: InlineKeyboardMarkup option }
let defaultInvoiceArgs = { SendInvoiceArgs.PhotoUrl = None; Description = None;
    PhotoSize = None; PhotoWidth = None; PhotoHeight = None; NeedName = None;
    NeedPhoneNumber = None; NeedEmail = None; NeedShippingAddress = None;
    IsFlexible = None; ReplyToMessageId = None; ReplyMarkup = None }
